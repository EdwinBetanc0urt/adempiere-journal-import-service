 ...
 ************************************************************************************/
package org.spin.journal_import.setup;
...
//		Ini.setProperty(Ini.P_ADEMPIERE_APPS_TYPE, "wildfly");
	...
	/**
	 * @return
	 * @see org.spin.journal_import.setup.SetupWrapper#getDatabase()
	 */
	...
	/**
	 * @return
	 * @see org.spin.journal_import.setup.SetupWrapper#getServer()
	 */
